...
- **32~39장** — **비워 둠**. ADP 필기 이론 4개 과목(데이터 이해·처리 기술·분석 기획·시각화 인사이트)용. 공식 가이드북 확보 후 제작.
- **40~45장 (PART F)** — 분석 기법 보강: 군집·연관·시계열·텍스트마이닝·사회연결망·다변량 심화
- **46~48장** — 예정. ADP 시험 대비(서술형 답안법·실기 240분 시나리오·R 코드 독해)
