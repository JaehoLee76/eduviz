...
(function(){
  ...
  { id:'py15_02',
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, s=this.s;
      ...
      E.big('nn.Conv2d — 합성곱 층', 'PyTorch에서 합성곱 한 줄은 nn.Conv2d(in_channels, out_channels, kernel_size)입니다. 작은 3×3 필터를 이미지 위로 한 칸씩 미끄러뜨리며, 겹친 9개 값과 필터를 곱해 더한 ‘내적’ 하나를 특징맵 한 칸에 적죠. 여기 필터는 왼쪽 −, 오른쪽 + 라서 좌우 밝기차가 큰 자리 — 세로 에지 — 에서 값이 크게 튑니다. 슬라이더를 끝까지 밀어 보세요. 화면의 모든 내적값은 그 자리 픽셀로 계산한 것입니다. out_channels=8이면 이런 필터가 8장, 서로 다른 특징을 동시에 찾습니다.'); }
  },
