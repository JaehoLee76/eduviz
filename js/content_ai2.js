/* 인공지능 제2장 — 데이터와 학습: 데이터 종류 · 스케일링(정규화/표준화) · 인코딩·결측치 · 특징 공학 · 데이터 양과 성능
...
(function(){
  ...
  { id:'ai2_04',
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, s=this.s;
      ...
      E.big('특징 공학 — 좋은 특징이 모델 절반', '왼쪽 두 고리는 직선으로 못 가릅니다. 그런데 <b>새 특징 r=√(x²+y²)</b> 하나를 만들면, r 임계값 하나로 <b>완벽히 분리</b>되죠(정확도 실측). 복잡한 모델보다 <b>좋은 특징</b>이 더 강력할 때가 많습니다 — 이것이 특징 공학입니다.'); }
  },
