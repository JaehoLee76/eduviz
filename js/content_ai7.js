...
(function(){
  ...
  { id:'ai7_02',
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, s=this.s;
      ...
      ctx.fillText('각 가중치의 그래디언트 (∂L/∂θ) — 수치미분 실측', tx, ty);
      var lr=0.3;
      ...
      E.big('역전파 — 오차를 거꾸로 흘려 모든 기울기를 한 번에', '순전파로 예측 ŷ와 손실 L을 구한 뒤, 연쇄법칙을 출력에서 입력 방향으로 거꾸로 적용하면 모든 가중치의 ∂L/∂θ를 한 번의 역방향 통과로 전부 얻습니다. 여기 네 그래디언트는 손실 함수를 각 가중치로 직접 수치미분한 실측값 — 부호는 ‘이 가중치를 키우면 손실이 늘까 줄까’를 말해 줍니다.'); }
  },
