...
(function(){
  ...
  { id:'calc15_01',
    enter:function(E){ this.s={t:0}; E.Plot.range(-3,3,-3,3);
  ...
  { id:'calc15_02',
    enter:function(E){ this.s={t:1.5}; E.Plot.range(-3,3,-3,3);
  ...
  { id:'calc15_03',
    enter:function(E){ this.s={bend:0.5}; E.Plot.range(-1,4,-1,4);
  ...
  { id:'calc15_05',
    enter:function(E){ this.s={R:1.8}; E.Plot.range(-3,3,-3,3);
