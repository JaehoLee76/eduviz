...
(function(){
  ...
  { id:'algo0_00', cinematic:true, introCard:true,
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, fr=E.frame, s=this.s;
      ...
      var ANIM=1080, FADE=18, HOLD=180; var _n=(typeof performance!=="undefined"&&performance.now)?performance.now():0, _dt=s.last?(_n-s.last):16.7; if(_dt<0||_dt>200)_dt=16.7; s.last=_n; s.acc=(s.acc||0)+_dt*0.06; var local=s.acc;
