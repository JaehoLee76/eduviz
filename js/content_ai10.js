...
(function(){
  ...
  { id:'ai10_01',
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, s=this.s;
      ...
      E.big('워드 임베딩 — 단어를 벡터로', '컴퓨터는 글자를 직접 이해하지 못합니다. 그래서 단어를 <b>숫자 벡터</b>로 바꾸죠 — 이것이 임베딩입니다. 비결은 <b>의미가 비슷한 단어를 가까운 곳에 두는 것</b>. 그러면 ‘가깝다’는 기하학적 거리가 곧 ‘뜻이 닮았다’가 됩니다. 화면의 이웃·유사도는 실제 좌표로 계산한 값입니다.'); }
  },
  ...
  { id:'ai10_02',
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, s=this.s;
      ...
      E.big('코사인 유사도 — 방향이 닮은 정도', '두 단어가 ‘얼마나 비슷한가’는 벡터 사이의 <b>각도</b>로 잽니다. 길이는 무시하고 <b>방향</b>만 보는 거죠 — 같은 방향이면 cos θ=1, 직각이면 0, 반대면 −1. 이것이 <b>코사인 유사도</b>입니다. 화면의 cos θ·각도는 실제 내적과 길이로 계산한 값입니다. 다음 장의 어텐션도 바로 이 ‘내적으로 닮음 재기’ 위에 서 있습니다.'); }
  },
  ...
  { id:'ai10_03',
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, s=this.s;
      ...
      E.big('벡터 산술 — 의미가 계산이 된다', '임베딩의 놀라운 성질: 단어 벡터끼리 <b>덧셈·뺄셈</b>을 하면 의미가 계산됩니다. ‘왕’에서 ‘남자’를 빼고 ‘여자’를 더하면 — 놀랍게도 ‘여왕’ 근처에 떨어지죠. 즉 <b>king − man + woman ≈ queen</b>. ‘왕다움’에서 성별만 바꾼 셈입니다. 화면의 결과 좌표와 가장 가까운 단어는 실제 벡터 덧뺄셈과 유사도로 찾은 것입니다.'); }
  },
  ...
  { id:'ai10_04',
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, s=this.s;
      ...
      E.big('어텐션 입문 — 정보 병목을 푸는 길', 'RNN은 문장 전체를 <b>맥락벡터 하나</b>에 욱여넣어 디코더에 넘겼습니다 — 길어지면 앞 정보가 뭉개지는 <b>정보 병목</b>이죠. <b>어텐션</b>은 발상을 뒤집습니다: 출력할 때 입력의 <b>모든 단어를 직접 보고</b>, 지금 관점(쿼리)과 닮은 단어에 더 주목합니다. 주목도는 쿼리·단어 벡터의 <b>내적을 Softmax</b>한 실제 계산값 — 이 닮음 재기가 바로 앞에서 배운 코사인·내적입니다.'); }
  },
