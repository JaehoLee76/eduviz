...
(function(){
  ...
  { id:'ai13_02',
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, s=this.s;
      ...
      E.big('RLHF — 사람의 선호로 모델을 "정렬"한다', '지시튜닝만으론 "좋은 답"의 미묘한 기준(도움됨·정직함·안전함)을 다 못 가르칩니다. 그래서 ①모범 응답으로 기본기를 잡고 ②사람이 두 답을 <b>A&gt;B</b>로 비교한 선호로 “점수 매기는 <b>보상모델</b>”을 학습한 뒤 ③그 점수를 최대화하도록 <b>강화학습</b>합니다. 화면의 보상 r은 특징 가중합으로 정해집니다.'); }
  },
