...
(function(){
  ...
  { id:'phys3_01',
    ...
    draw:function(E){ var s=this.s, w=s.w, b=s.b, W=E.W, H=E.H;
      ...
      E.tapHint(W/2, H*0.90, '↻ 처음으로 (D) · 슬라이더로 F 조절', true);
  ...
  { id:'phys3_03',
    enter:function(E){ var self=this; this.s={grab:false,E0:null};
      ...
      E.setOn([]); },
    tap:function(E){ var b=this.s.b; b.x=5; b.y=6; b.vx=0; b.vy=0; this.s.E0=null; E.blip(360,0.12); },
    down:function(E,cx,cy){ var s=this.s, v=s.view; if(!v)return; var b=s.b, wy=v.wy(cy), wx=v.wx(cx);
      if(Math.hypot(b.x-wx,b.y-wy)<b.r+0.6){ b.held=true; b.vx=0; b.vy=0; s.grab=true; } },
    ...
    draw:function(E){ var s=this.s, w=s.w, b=s.b, ctx=E.ctx, W=E.W, H=E.H;
      ...
      E.tapHint(W/2, H*0.93, '공을 끌어 높이 조절 → 놓으면 낙하 · ↻ 초기화 (D)', true);
  ...
  { id:'phys3_04',
    ...
    draw:function(E){ var s=this.s, w=s.w, b=s.b, ctx=E.ctx, W=E.W, H=E.H;
      ...
      E.tapHint(W/2, H*0.90, '↻ 다시 밀기 (D) · 슬라이더로 μ', true);
  ...
  { id:'phys3_05',
    ...
    draw:function(E){ var s=this.s, w=s.w, b=s.b, ctx=E.ctx, W=E.W, H=E.H;
      ...
      E.tapHint(W/2, H*0.955, '↻ 처음으로 (D) · 슬라이더로 F', true);
