...
(function(){
  ...
  { id:'py13_02',
    ...
    draw:function(E){ var ctx=E.ctx, W=E.W, H=E.H, s=this.s, op=s.op;
      ...
      E.big('텐서 연산 — NumPy 그대로, 더하기 자동미분', '+ 와 * 는 같은 위치끼리(원소별)이고, @ 는 행렬곱입니다. 신경망의 한 층은 결국 입력에 가중치 행렬을 @ 로 곱하는 일 — 그래서 텐서 연산이 곧 딥러닝의 계산입니다. reshape 는 데이터를 그대로 둔 채 모양만 바꾸죠. 오른쪽 결과 격자에서 바로 확인할 수 있습니다.'); }
  },
