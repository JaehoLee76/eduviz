...
const CACHE_NAME = 'adp-master-v20';
const CORE_ASSETS = [
  './',
  './index.html',
  ...
  './topics/degrees-of-freedom.js',
  './topics/population-definition.js',
  './topics/spread-terms.js',
  './topics/sd-not-a-limit.js',
  './topics/normal-curve-axes.js',
  './topics/qq-plot.js',
