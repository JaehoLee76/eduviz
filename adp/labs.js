...
window.ADP_LABS = [
  ...
  { no:'0008', href:'labs/0008-distribution-family.html', part:'가이드', type:'분포와 자유도', order:'0002 앞에',
    title:'자유도와 분포의 계보', sub:'z · χ² · t · F 는 어디서 왔나',
    desc:'표준정규 하나에서 카이제곱·t·F가 어떻게 만들어지는지, 자유도가 왜 빼는 수인지를 돌려 보고 끌어 보며 익힌다. 분산분석을 읽기 위한 토대.',
    done:true },
